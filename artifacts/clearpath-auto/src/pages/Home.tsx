    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative min-h-[85vh] flex items-center pt-20 pb-32 overflow-hidden bg-secondary">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            ...
            >
              <Link href="/models" data-testid="btn-hero-models">
                <Button size="lg" className="w-full sm:w-auto h-14 px-8 rounded-none font-bold tracking-wide uppercase text-base">
                  Pick Your Model
                </Button>
              </Link>
              <Link href="/how-it-works" data-testid="btn-hero-how">
                <Button size="lg" variant="outline" className="w-full sm:w-auto h-14 px-8 rounded-none font-bold tracking-wide uppercase text-base border-white text-white hover:bg-white hover:text-secondary">
                  How it Works
                </Button>
              </Link>
            </motion.div>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold uppercase tracking-tight mb-4">Featured Vehicles</h2>
              <p className="text-muted-foreground max-w-2xl text-lg">The Jeep Wrangler alone gets 74,000 searches a month. We make it easy to get yours without the hassle.</p>
            </div>
            <Link href="/models" className="hidden md:flex items-center font-bold uppercase tracking-wider text-primary hover:text-primary/80 transition-colors" data-testid="link-view-all">
          ...
          >
            {[
              { name: "Jeep Wrangler", img: jeepWrangler, desc: "The ultimate off-road icon." },
              { name: "Ford Bronco", img: fordBronco, desc: "Built wild for the modern trail." },
              { name: "Ram 1500", img: ram1500, desc: "Premium capability and comfort." }
            ].map((model, i) => (
              <motion.div key={i} variants={item}>
                <Card className="rounded-none border-border overflow-hidden group cursor-pointer h-full flex flex-col">
                  ...
                  <CardContent className="p-6 flex-1 flex flex-col">
                    <h3 className="text-xl font-bold uppercase tracking-tight mb-2">{model.name}</h3>
          ...
          <div className="mt-8 md:hidden text-center">
            <Link href="/models">
              <Button className="rounded-none font-bold uppercase w-full">View All Models</Button>
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">We believe buying a car shouldn't feel like a battle. We act as your agent, leveraging our network to get exactly what you want without the typical dealership games.</p>
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold uppercase tracking-wide mb-1">{item.title}</h4>
            ...
            <div className="relative">
              ...
              <img src={fordBronco} alt="Delivery" className="w-full aspect-square object-cover border-4 border-background" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-primary text-primary-foreground text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <Link href="/request">
            <Button size="lg" variant="outline" className="h-16 px-10 rounded-none font-bold uppercase tracking-widest text-lg border-white text-primary hover:bg-white hover:text-primary bg-white">
              Start Your Request
            </Button>
          </Link>
        </div>
