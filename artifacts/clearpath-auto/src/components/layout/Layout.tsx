...
import { Map, Truck, User, ArrowRight } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/models" className="text-muted-foreground hover:text-white transition-colors text-sm">Browse Models</Link></li>
